...
@implementation HJSegmentedControl
...
- (void)touchesCancelled:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [self setSelectedSegmentIndex:self.valueAtStartOfTouches animated:NO];
